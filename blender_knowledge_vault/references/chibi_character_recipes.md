...
## 6. 髪型バリエーション（7種）とランダム要素抽選

キャラクター作成の幅を広げるため、7種のアイコニックなヘアスタイルと、ガチャ感覚でキャラを自動生成する要素抽選システムを実装しています。

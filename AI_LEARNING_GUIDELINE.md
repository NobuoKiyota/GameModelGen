...
> [!CAUTION]
> **【最優先】実装を開始する前に、必ず [`AI_LEARNING_RULES_FOR_GEMINI.md`](./AI_LEARNING_RULES_FOR_GEMINI.md) を読むこと。**  
> URL幻覚・完了幻覚・数値捏造など「AIが陥りやすい7大失敗パターン」と、  
> それを防ぐための義務チェックリストが定義されています。本SOPより上位の規程です。

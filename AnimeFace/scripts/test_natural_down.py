...
# Set natural side-hanging pose for arms
for side, sign in [('L', 1), ('R', -1)]:
    ...
    pb_u.rotation_euler = (-0.95, 0, 0) # Hang straight down
...
bpy.context.scene.render.filepath = "Z:/MeshCreator/AnimeFace/out/renders_test/test_arms_natural_down.png"
bpy.ops.render.render(write_still=True)
print("Rendered test_arms_natural_down.png")

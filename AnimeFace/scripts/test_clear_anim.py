...
# Completely clear animation data to prevent frame evaluation overriding
arm.animation_data_clear()

# Set rest pose or test pose
...
bpy.context.scene.render.filepath = "Z:/MeshCreator/AnimeFace/out/renders_test/test_arm_cleared_anim.png"
bpy.ops.render.render(write_still=True)
print("Rendered test_arm_cleared_anim.png")

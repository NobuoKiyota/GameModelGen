...
# Remove all mask modifiers from BodyBase and BodyArm if any
...
bpy.context.scene.render.filepath = "Z:/MeshCreator/AnimeFace/out/renders_test/test_face_hair_raw_rest.png"
bpy.ops.render.render(write_still=True)
print("Rendered test_face_hair_raw_rest.png")

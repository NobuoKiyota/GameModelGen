    ...
    def draw(self, context):
        ...
        if props.studio_tab == 'SHAPE':
            ...
            if props.prop_category == 'CHIBI_CHARACTER':
                ...
                box_parts.prop(props, "chibi_eyebrow_style", text="眉毛")
            ...
            # 🚪 Western Arch Door Preset Specific（ダンジョン向け経年劣化両開き扉）
                ...
                # 💥 破壊アニメーション（木っ端微塵・UE持ち込み用）
                box_d_destroy = box_door.box()
                box_d_destroy.label(text="💥 破壊アニメーション (Destruction / for Unreal Engine):", icon='MOD_EXPLODE')
                row_d_destroy_param = box_d_destroy.row(align=True)
                ...
                box_d_destroy.prop(props, "door_destruction_impact_strength", text="飛散の強さ")
